        ...
        <section className="pricing container section">
            ...
            <div className="pricing__container grid">
                <div className="pricing__item">
                    ...
                    <p className="pricing__title">A Simple option but powerfull to manage your business</p>
                ...
                <div className="pricing__item">
                    <img src={Image2} width="70" height="70" alt="" className="pricing__img" />
                ...
                <div className="pricing__item">
                    <img src={Image3} width="70" height="70" alt="" className="pricing__img" />
